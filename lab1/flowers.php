...
$flowers=[
    [
        'name'=>'Hoa Đỗ Quyên',
        'description'=>'Cây hoa đỗ quyên là loài cây thân gỗ hoặc thân gỗ bụi, có nguồn gốc từ các vùng ôn đới. Tên khoa học của hoa đỗ quyên là Rhododendron, thuộc họ Thạch nam (Ericaceae). Chi của cây hoa này bao gồm khoảng từ 850 đến 1000 loài khác nhau, đa số có hoa nở rực rỡ với nhiều gam màu khác nhau.',
        'image'=>'images/doquyen.jpg'
    ],
    [
        'name'=>'Hoa Hải Đường',
        'description'=>'Đây là loài cây nhỡ, thân gỗ, cao đến 3m, dạng bụi. Cành nhánh nhiều, dài xum xuê. Lá mọc cách, nhẵn, bóng, màu xanh đậm, mép có răng cưa nhỏ.',
        'image'=>'images/haiduong.jpg'
    ],
    [
        'name'=>'Hoa Mai',
        'description'=>'Hoa mai vàng có năm cánh và thường nở trùng với dịp Tết Nguyên Đán như hoa đào ở miền Bắc nên người ta đã đem về trang trí vào dịp Tết. Dần dà về sau, hoa mai trở thành một hình ảnh đặc trưng khi nhắc đến ngày tết của miền Nam Việt Nam.',
        'image'=>'images/mai.jpg'
    ],
    [
        'name'=>'Hoa Tường Vy',
        'description'=>'Hoa tường vi là loài hoa hồng bản địa của Đông Á, có nhiều tên gọi khác nhau như hồng nhiều hoa, tường vi Nhật,... và thường xuyên bị nhiều người nhầm lẫn với loài hoa tử vi.',
